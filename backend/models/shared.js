...
const lessonTypeValues = ['translation', 'choice', 'grammar', 'sentence', 'listening', 'speaking', 'theory', 'matching'];
const exerciseTypeValues = ['translation', 'choice', 'grammar', 'sentence', 'listening', 'speaking', 'matching'];
